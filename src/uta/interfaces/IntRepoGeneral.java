 ...
 * @author ASUS
 */
public class IntRepoGeneral extends javax.swing.JInternalFrame {

    /**
     * Creates new form IntRepoGeneral
     */
    public IntRepoGeneral() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IntRepoGeneral.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IntRepoGeneral().setVisible(true);
            }
        });
    }
